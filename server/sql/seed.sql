...
VALUES
  ('yesella-meaning', '한글리시', '한글리시 의미', '한글리시 의미', '합격과 점수 상승을 만드는 스터디 운영 시스템', '한글리시는 예측 가능한 학습 설계와 실행력으로 학생의 성장을 만드는 학습 브랜드입니다.', JSON_ARRAY(), NULL),
  ('yesella-goal', '한글리시', '한글리시 학습목표', '한글리시 학습목표', '측정 가능한 성과 중심 학습', '주간 루틴 정착, 실전 점수 향상, 최종 합격까지 관리합니다.', JSON_ARRAY('학습 습관 정착', '실전 점수 향상', '최종 합격 완성'), NULL),
  ('yesella-diff', '한글리시', '한글리시만의 차별성', '한글리시만의 차별성', '데이터 + 코칭 + 실행관리', '학습량/정답률 데이터 기반으로 개인별 개선 경로를 제공합니다.', JSON_ARRAY('데이터 리포트', '1:1 피드백', '완주관리'), NULL),
  ...
  ('direction', '학원 안내', '오시는 길', '오시는 길', '한글리시 학원 위치 안내', '서울시 강남구 테헤란로 123, 한글리시빌딩 5층', JSON_ARRAY(), NULL)
